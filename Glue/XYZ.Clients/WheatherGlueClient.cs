...
on 5/10/2017 2:07:37 PM at SEXTOD by Anton
...
{
  ///<summary>
  /// Client for glued contract XYZ.BusinessDomain.Contracts.IWheather server.
  /// Each contract method has synchronous and asynchronous versions, the later denoted by 'Async_' prefix.
  /// May inject client-level inspectors here like so:
  ///   client.MsgInspectors.Register( new YOUR_CLIENT_INSPECTOR_TYPE());
  ///</summary>
  public class WheatherGlueClient : ClientEndPoint, @XYZ.@BusinessDomain.@Contracts.@IWheather
  {
  ...
  #region Static Members
     ...
     //static .ctor
     static WheatherGlueClient()
     {
         var t = typeof(@XYZ.@BusinessDomain.@Contracts.@IWheather);
  ...
  #region .ctor
     public WheatherGlueClient(string node, Binding binding = null) : base(node, binding) { ctor(); }
     public WheatherGlueClient(Node node, Binding binding = null) : base(node, binding) { ctor(); }
     public WheatherGlueClient(IGlue glue, string node, Binding binding = null) : base(glue, node, binding) { ctor(); }
     public WheatherGlueClient(IGlue glue, Node node, Binding binding = null) : base(glue, node, binding) { ctor(); }
     ...
     {
       get { return typeof(@XYZ.@BusinessDomain.@Contracts.@IWheather); }
     }
